                                                        ...
                                                        pkgs.writeShellApplication
                                                            {
                                                                ...
                                                                text =
                                                                    let
                                                                        ...
                                                                        in
                                                                            ''
                                                                                echo 832be1bd-516c-45a1-a114-5a8bf131fdd4 >> ${ resources-directory }/DEBUG2
                                                                                mkdir --parents /mount/git-repository
                                                                                echo 67146884-cc26-4917-a2a4-7aa136a2a697 >> ${ resources-directory }/DEBUG2
                                                                                cd /mount/git-repository
                                                                                echo b8d0a6e1-1e72-4cbd-9905-b73065ead0f7 >> ${ resources-directory }/DEBUG2
                                                                                git init 2>&1
                                                                                # echo 55810896-78f1-41a4-8082-c0f1fc2ce91d >> ${ resources-directory }/DEBUG2
                                                                                ...
                                                                                echo e7920f2a-8761-48f3-b20d-0c62ed74c05d >> ${ resources-directory }/DEBUG2
                                                                                ${ setup-visit }
                                                                                echo ba79940a-a4be-4fd9-9f6e-776475f43e5d >> ${ resources-directory }/DEBUG2
                                                                            '' ;
                                                            } ;
